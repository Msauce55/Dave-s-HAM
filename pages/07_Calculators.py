...
<style>
    ...
    .stSelectbox > div > div, .stSelectbox [data-baseweb="select"] > div {
        ...
        border: 1px solid #00f0ff88 !important;
    }
...
calc = st.radio("Select calculator", ["Half-wave Dipole", "Simple Yagi Estimate", "Coax Loss", "Wavelength"], horizontal=True)
...
if calc == "Half-wave Dipole":
    ...
    cable = st.radio("Cable", ["RG-58", "RG-8X", "RG-213 / LMR-400", "LMR-600"], horizontal=True)
